...
//
// import '../Model/OrdersModel/OrderItemsModel.dart';
//
...
//         print(getDeliveryBoysApi.toString());
...
//                   .toList();
//
//               totalPayable = int.parse(tempList[0].pacCharge.toString()) + int.parse(tempList[0].payable.toString()) + int.parse(tempList[0].delCharge.toString());
//
//               print("TOTAL AMOUNT===== $totalPayable");
//
...
//                       });
//                       updateOrder(
//                           curSelected, updateOrderItemApi, id, item, );
//                     }
//                   },
//                 ),
//               ],
...
//                                 .button!
//                                 .copyWith(color: lightBlack2)),
//                         Text("+ " + CUR_CURRENCY + " " + tempList[0].pacCharge!,
//                             style: Theme.of(context)
//                                 .textTheme
//                                 .button!
//                                 .copyWith(color: lightBlack2))
...
//                         style: Theme.of(context).textTheme.button!.copyWith(
//                             color: lightBlack, fontWeight: FontWeight.bold)),
//                     Text(CUR_CURRENCY + " " + totalPayable.toString(),
//                         // CUR_CURRENCY + " " + tempList[0].payable!,
//                         style: Theme.of(context).textTheme.button!.copyWith(
//                             color: lightBlack, fontWeight: FontWeight.bold))
//                   ],
//                 ),
...
class OrderDetail extends StatefulWidget {
  ...
  const OrderDetail({
    ...
    // this.model,
    // this.updateHome,
    this.id, required Order_Model model,
  }) : super(key: key);
      ...
      apiBaseHelper.postAPICall(getOrdersApi, parameter).then(
          ...
          if (!error) {
            ...
            if (data.length != 0) {
              ...
              totalPayable = double.parse(tempList[0].payable.toString());
                      ...
                      children: [
                        ...
                        model!.delDate != null &&
                          ...
                          child: Padding(
                            ...
                            : Container(),
                        //iteam's here
                        // orderItem.status == null? Text("error")
                        //  :
                        model?.itemList![0].status != null ?
                        orderStatus() :
                        Text("error"),
                      //
                      // :   ,
